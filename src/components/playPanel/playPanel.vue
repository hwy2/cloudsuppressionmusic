      ...
      <div class="container">
        ...
        <div class="disc">
          <div class="cantilever">
            <img v-show="!isPlay"
                 ...
                 alt="cantilever" />
            <img v-show="isPlay"
                 src="../../assets/images/playAuto.png"
                 alt="cantilever" />
          </div>
        ...
        <div class="operation">
          ...
          <div class="roadcast">
            ...
            <i class="iconfont iconshangyishoushangyige"
               @click="playlast()"></i>
            <i v-if="!isPlay"
            ...
            <i v-if="isPlay"
               ...
               @click="pauseMusic()"></i>
            <i class="iconfont iconxiayigexiayishou"
               @click="playnext()"></i>
  ...
  methods: {
    ...
    handleLyric ({ lineNum, txt }) {
      ...
      if (lineNum > 2) {
        ...
        this.$refs.lyricList.scrollTop = 0; // 滚动到顶部
      }
